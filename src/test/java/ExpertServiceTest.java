...
public class ExpertServiceTest {
    ...
    void testAjouterExpert() throws SQLException {
        Expert expert = new Expert(
                "foulen", "benfoulen", 44556677, "foulen@gmail.com", "motdepasse",
                Role.EXPERT.toString(), LocalDate.parse("2026-02-15"),
                "signature44.png", "certification44.pnj"
        );
        ...
        Expert inserted = experts.stream()
                .filter(ex -> "foulen".equals(ex.getNom()) && "foulen@gmail.com".equals(ex.getEmail()))
    ...
    void testModifierExpert() throws SQLException {
        ...
        assertEquals("foulen.mod@gmail.com", found.getEmail());
    ...
    void testEmailExiste() throws SQLException {
        assertTrue(se.emailExiste("foulen.mod@gmail.com"), "emailExiste devrait retourner true");
        assertFalse(se.emailExiste("email.inexistant.12345@gmail.com"), "emailExiste devrait retourner false");
    }
    ...
    void testModifierMotDePasseParEmail() throws SQLException {
        ...
        se.modifierMotDePasseParEmail("foulen.mod@gmail.com", newPwd);
        ...
        assertNotNull(found);
        assertEquals(newPwd, found.getMotDePasse(), "Le mot de passe dans experts n'a pas été mis à jour");
    ...
    void testSupprimerExpert() throws SQLException {
        ...
        assertFalse(experts.stream().anyMatch(ex -> ex.getId() == idExpert),
                "L'expert n'a pas été supprimé de la table experts");
    }
}
//--------------------------------------------------------------------------------------------------------------------
/*
