...
public class ProfilUtilisateur {
    ...
    @FXML
    private Button listeParcellesButton;
    ...
    @FXML
    private Label cinValue;
    @FXML
    private Label emailValue;
    @FXML
    private Label dateCreationValue;

    // signature
    @FXML
    private Label signaturePathValue;
    @FXML
    ...
    @FXML
    private Label parcellesValue;
    @FXML
    private Label carteProPathValue;
    @FXML
    private ImageView carteProImage;

    // expert
    @FXML
    private VBox expertBox;
    @FXML
    private Label certificationPathValue;
    @FXML
