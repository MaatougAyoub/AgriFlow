...
public class MainController implements Initializable {
    ...
    public void afficherMarketplace() {
        loadView("/com/agriflow/marketplace/views/Marketplace.fxml");
        setActiveButton(btnMarketplace);
    }

    @FXML
    public void afficherAjout() {
        loadView("/com/agriflow/marketplace/views/AjouterAnnonce.fxml");
        setActiveButton(btnAjout);
    }

    @FXML
    public void afficherReservations() {
        loadView("/com/agriflow/marketplace/views/MesReservations.fxml");
        setActiveButton(btnReservations);
    }

    @FXML
    public void afficherAdmin() {
        loadView("/com/agriflow/marketplace/views/AdminDashboard.fxml");
