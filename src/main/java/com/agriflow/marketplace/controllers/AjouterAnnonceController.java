...
import com.agriflow.marketplace.services.FraudControlService;
import com.agriflow.marketplace.services.GeminiAIService;
...
public class AjouterAnnonceController implements Initializable {
    ...
    private void retourMarketplace() {
        naviguerVers("/com/agriflow/marketplace/views/Marketplace.fxml");
    }
