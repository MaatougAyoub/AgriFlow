...
public class MarketplaceController implements Initializable {
        ...
        for (Annonce annonce : annonces) {
            try {
                FXMLLoader loader = new FXMLLoader(
                        getClass().getResource("/com/agriflow/marketplace/views/AnnonceCard.fxml"));
    ...
    private void onEditAnnonce(Annonce annonce) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/agriflow/marketplace/views/AjouterAnnonce.fxml"));
    ...
    private void openReservationDialog(Annonce annonce) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/agriflow/marketplace/views/ReservationDialog.fxml"));
    ...
    private void openAjouterAnnonce() {
        naviguerVers("/com/agriflow/marketplace/views/AjouterAnnonce.fxml");
    }
