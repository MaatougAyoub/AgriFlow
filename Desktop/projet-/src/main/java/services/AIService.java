...
public class AIService {
    ...
    private static final String GROQ_KEY = "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";
    private static final String API_URL = "https://api.groq.com/openai/v1/chat/completions";

    /**
     * Analyse l'image et retourne un diagnostic agronomique complet.
     */
    public String decrireImage(File selectedFile) {
        try {
            ...
            String instructions = "Agis en tant que système AGRIFLOW. "
                    + "Rédige une demande de réclamation agricole claire et professionnelle "
                    + "basée sur cette image. "
                    + "Décris le problème observé sur la culture ou le fruit, "
                    + "explique les dommages possibles et formule une demande d'intervention "
